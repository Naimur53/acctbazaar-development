...
export default function AddSellAccount({ updateProgress }: TAddSellAccount) {
    ...
    return (
        <div className='bg-white rounded-2xl w-full min-h-[80vh] p-4 md:p-6 2xl:p-8'>
            <h2 className="subTitle pt-2 2xl:pt-6 pb-6 2xl:pb-8 text-center">Add Account</h2>
            ...
            >
                ...
                <div className=''>
                    <AppFormInput
                        ...
                        error={errors?.name}
                    />
                    <p className="textG font-normal">For e.g., 4 Years Facebook Account</p>
                </div>
                <AppFormTextarea
                    label="Description"
                    name="description"
                ...
                <div className='flex items-center justify-center'>
                    <button type="submit" className="appBtn px-10">Continue</button>
                </div>
            </form>
        </div>
    );
