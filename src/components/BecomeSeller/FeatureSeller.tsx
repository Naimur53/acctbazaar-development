...
export default function FeatureSeller() {
    ...
    const featureCards = [
        {
            ...
            details: "Expand your reach beyond local markets and connect with buyers worldwide.",
        ...
        },
        {
            ...
            details: "Quickly upload product details, images, and set your preferred pricing. Simple and user-friendly interface for effortless product listing.",
        ...
        },
        {
            ...
            details: "Built-in secure payment system to ensure smooth and safe transactions. Gain trust from buyers with our reliable payment processing.",
        ...
        },
        {
            ...
            details: "Understand customer behavior and tailor your strategy for better results. Access detailed insights into your sales performance.",
    ...
    return (
        <div className='container px-4 py-20 text-textBlack'>
            ...
            <div className='grid grid-cols-1 lg:grid-cols-2 gap-8' data-aos="fade-down" data-aos-duration="1500">
                {
