...
const MarketplaceSidebar = () => {
    ...
    return (
        <div>
            ...
            <div className=''>
                <h3 className="border-b border-b-[#E4E4E4] px-4 md:px-5 pb-2 md:pb4- text-textBlack font-medium">Account Category</h3>
                <div className='pt-2'>
                    {sidebarMenu.map(sidebar => (
                        <MarketPlaceSidebarFilterElement key={sidebar?.label} sidebar={sidebar} />
                    ))}
                </div>
                {/* this is price range  */}
