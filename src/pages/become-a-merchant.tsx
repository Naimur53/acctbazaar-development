...
export default function index() {
    const readySection = {
        ...
        details: "Join Acctbazaar today and experience the benefits of a vibrant P2P selling community. Sign up now to start your journey towards increased visibility, sales, and success.",
